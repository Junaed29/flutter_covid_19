...
/// updated : 1646322744578
/// cases : 441104342
/// todayCases : 812530
/// deaths : 5995698
/// todayDeaths : 3266
/// recovered : 374027099
/// todayRecovered : 1033729
/// active : 61081545
/// critical : 73653
/// casesPerOneMillion : 56590
/// deathsPerOneMillion : 769.2
/// tests : 5885147550
/// testsPerOneMillion : 746380.38
/// population : 7884917270
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 7746.63
/// recoveredPerOneMillion : 47435.77
...
class WorldStatesModel {
  ...
  @override
  String toString() {
    return 'WorldStatesModel{_updated: $_updated, _cases: $_cases, _todayCases: $_todayCases, _deaths: $_deaths, _todayDeaths: $_todayDeaths, _recovered: $_recovered, _todayRecovered: $_todayRecovered, _active: $_active, _critical: $_critical, _casesPerOneMillion: $_casesPerOneMillion, _deathsPerOneMillion: $_deathsPerOneMillion, _tests: $_tests, _testsPerOneMillion: $_testsPerOneMillion, _population: $_population, _oneCasePerPeople: $_oneCasePerPeople, _oneDeathPerPeople: $_oneDeathPerPeople, _oneTestPerPeople: $_oneTestPerPeople, _activePerOneMillion: $_activePerOneMillion, _recoveredPerOneMillion: $_recoveredPerOneMillion, _criticalPerOneMillion: $_criticalPerOneMillion, _affectedCountries: $_affectedCountries}';
  }
}
